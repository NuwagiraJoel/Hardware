(function ($) {
  ...
  $(".hero-slider-active").slick({
    ...
    dots: true,
    prevArrow:
      '<button type="button" class="slick-prev"><i class="fa-sharp fa-solid fa-arrow-left"></i></button>',
    nextArrow:
      '<button type="button" class="slick-next"><i class="fa-sharp fa-solid fa-arrow-right"></i></button>',
    responsive: [
      {
        breakpoint: 768,
        settings: {
  ...
  $(".deals-carousel-active-2").each(function () {
    ...
    var $arrowContainer = $(this)
      .parent()
      .siblings(".section-header-inner_2")
      .find(".slick-append");
    $this.slick({
      infinite: true,
      prevArrow:
